...
public class MaudGenericDialog extends Dialog implements ActionListener,
  ...
  public MaudGenericDialog(String title, Frame parent) {
  ...
  /** Displays this dialog box. By Luca */
  public void showDialog(Button additionalB) {
    resetIndices();
    if (macro) {
    ...
    additionalB.addActionListener(this);
    buttons.add(additionalB);
