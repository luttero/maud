 ...
 * <A HREF="#toXRDcatString()">toXRDcatString()</A> is used by the AuthorizationModule
 ...
 * the cookie field is non-null then toXRDcatString() will generate the first
...
public class AuthorizationInfo implements Cloneable
{
    ...
    /** additional info which won't be displayed in the toXRDcatString() */
     ...
     *
     * @param  params an array of name/value pairs.
     */
