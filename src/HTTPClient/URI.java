...
public class URI
{
	...
	defaultPorts.put("shttp",     80);
	defaultPorts.put("http-ng",   80);
	defaultPorts.put("coffee",    80);
	...
	defaultPorts.put("hnews",     80);
	defaultPorts.put("smtp",      25);
	defaultPorts.put("gopher",    70);
	defaultPorts.put("wais",      210);
	defaultPorts.put("whois",     43);
	defaultPorts.put("whois++",   63);
	defaultPorts.put("rwhois",    4321);
	defaultPorts.put("imap",      143);
	defaultPorts.put("pop",       110);
	defaultPorts.put("prospero",  1525);
	defaultPorts.put("irc",       194);
	defaultPorts.put("ldap",      389);
	defaultPorts.put("nfs",       2049);
	defaultPorts.put("z39.50r",   210);
	defaultPorts.put("z39.50s",   210);
	defaultPorts.put("vemmi",     575);
	defaultPorts.put("videotex",  516);
	defaultPorts.put("cmp",       829);
