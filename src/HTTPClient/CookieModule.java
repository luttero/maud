...
public class CookieModule implements HTTPClientModule
{
	     ...
	     cookie_jar.isFile()  &&  cookie_jar.canWrite()))
	{
	    ...
	    Enumeration enum1 = Util.getList(cookie_cntxt_list,
	    ...
	    {
		Cookie cookie = (Cookie) enum1.nextElement();
		if (!cookie.discard())
	...
	synchronized (cookie_list)
	{
	    ...
	    Enumeration enum1 = cookie_list.elements();
	    while (enum1.hasMoreElements())
		cookies[idx++] = (Cookie) enum1.nextElement();
