/*
 * $Id: SGLabel.java,v 1.1 2004/12/27 16:15:20 luca Exp $
 *
...
/*    boolean t1 = !ident_.equals(sg.getId());
  ...
  /**
   * Set the label reference location in physical coordinates.
  ...
  /**
   * Get the label reference location in physical coordinates.
   *
