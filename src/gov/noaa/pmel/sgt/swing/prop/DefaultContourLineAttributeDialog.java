/*
 * $Id: DefaultContourLineAttributeDialog.java,v 1.1 2004/12/27 16:15:22 luca Exp $
 *
...
//    arrayEditor.setMargin(pup);
  ...
  private float[] dashArray() {
    ...
    while(token.hasMoreTokens()) {
      array[index] = Float.parseFloat(token.nextToken());
      index++;
    }
    return array;
  }
  ...
  void updateDefaultContourLineAttribute() {
    ...
    // heightP
    //
    attr_.setLabelHeightP(Double.parseDouble(heightTextField.getText()));
    //
    // label format
    //
    ...
    // significant digits
    //
    attr_.setSignificantDigits(Integer.parseInt(sigDigitsTextField.getText()));
  }
  /**
