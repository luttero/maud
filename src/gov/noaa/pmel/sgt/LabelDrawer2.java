/*
 * $Id: LabelDrawer2.java,v 1.2 2006/01/19 14:45:48 luca Exp $
 *
...
//	  System.out.println("Drawing 2D label: " + label_ + " " + );
...
//        System.out.println("\n angle = " + angle + ", text = " + label_ + " font: " + font_.getName());
//        System.out.println("oldTransform = " + oldTransform);
    AttributedString as = new AttributedString(label_);
/*	  Font oldFont = null;
	  if (angle != 0 && System.getProperty("os.name").toLowerCase().indexOf("mac") != -1) {
		  // OSX problem with turned italics
		  if (font_.isItalic()) {
			  oldFont = font_;
			  font_ = new Font(oldFont.getName(), Font.PLAIN, oldFont.getSize());
		  }
	  }*/
