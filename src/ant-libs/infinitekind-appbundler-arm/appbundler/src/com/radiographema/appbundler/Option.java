/*
 * Copyright 2022, Radiographema and/or its affiliates. All rights reserved.
 *
 * DO NOT ALTER OR REMOVE COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
 * This code is free software; you can redistribute it and/or modify it
 * under the terms of the GNU General Public License version 2 only, as
 * published by the Free Software Foundation.  Radiographema designates this
 * particular file as subject to the "Classpath" exception as provided
 * by Radiographema in the LICENSE file that accompanied this code.
 *
 ...
 *
 * Please contact Radiographema
 * or visit www.radiographema.com if you need additional information or have any
 * questions.
 */

package com.radiographema.appbundler;
 ...
 * is {@code com.Radiographema.appbundler}. Then you can override a named option by calling
 * <xmp>
 *     import java.util.prefs.Preferences;
 *     [...]
 *     Preferences jvmOptions = Preferences.userRoot().node("/com/Radiographema/appbundler/JVMOptions");
 *     jvmOptions.put("name", "value");
 *     jvmOptions.flush();
 * </xmp>
 * The corresponding entries will be stored in a file called
 * {@code ~/Library/Preferences/com.Radiographema.appbundler.plist}.
 ...
 * <xmp>
 *     defaults write com.Radiographema.appbundler /com/Radiographema/appbundler/ -dict-add JVMOptions/ '{"name"="value";}'
 * </xmp>
 *
