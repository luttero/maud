...
import it.unitn.ing.wizard.HIPPOWizard.detectorPanelDescriptor;
...
/*    if (WizardPanelDescriptor.IDENTIFIER.equals(identifier.toString())) {
      WizardPanelDescriptor descriptor2 = new WizardPanelDescriptor();
      registerWizardPanel(WizardPanelDescriptor.IDENTIFIER, descriptor2);
    }*/
  }
   ...
   /**
     * Mirrors the WizardModel method of the same name.
     * @param newValue newValue The new enabled status of the button.
     */ 
   ...
   /**
    ...
    private static Object getImage(String name) {
        ...
        try {
            Class c = Class.forName("it.unitn.ing.wizard.Wizard");
    ...
    static {
        ...
        try { 
            ...
            PropertyResourceBundle resources = (PropertyResourceBundle)
                ResourceBundle.getBundle("it.unitn.ing.wizard.wizard");
