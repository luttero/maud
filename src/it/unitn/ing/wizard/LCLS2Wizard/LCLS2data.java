...
public class LCLS2data {
	...
	public String author = "Sven";
	public String sampleName = "Sample_x";
	public int panelsNumber = LCLS2ConfigData.getPropertyValue("numberOfPanels", 5);
...
//	public Vector<String> uncorrectedImageFiles = new Vector(panelsNumber,1);
	...
	public Vector<Cspad> panels = new Vector(0,1);

	public LCLS2data(String title) {
		this.title = title;
	}
...
//		uncorrectedImageFiles.add(uncorrImageFile);
		...
		LCLSDetectorPanel panel = LCLS2ConfigData.detectorPanels.elementAt(panelNumber);
		...
		if (mydata != null) {
			for (int i = 0; i < panel.detectorsNumber; i++) {
				...
				SensorImage image = new SensorImage(photon);
				...
				String filename = LCLS2ConfigData.filenameToSave.substring(0, dotLocation) + image.name;
