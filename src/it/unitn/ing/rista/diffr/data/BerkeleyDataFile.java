/*
 * @(#)BerkeleyDataFile.java created 01/01/1997 Mesiano
 *
...
/**
 * The BerkeleyDataFile is a class
 *
...
public class BerkeleyDataFile extends it.unitn.ing.rista.diffr.DiffrDataFile {

  public BerkeleyDataFile(XRDcat aobj, String alabel) {
    super(aobj, alabel);
    identifier = ".spc";
  }

  public BerkeleyDataFile() {
    identifier = ".spc";
  }
