/*
 * @(#)DoubleColumnDataFile.java created 18/03/1999 Mesiano
 *
...
/**
 * The DoubleColumnDataFile is a class to load datafile
...
public class DoubleColumnDataFile extends it.unitn.ing.rista.diffr.DiffrDataFile {

  public DoubleColumnDataFile(XRDcat aobj, String alabel) {
    super(aobj, alabel);
    identifier = ".prn";
  }

  public DoubleColumnDataFile() {
    identifier = ".prn";
  }
