/*
 * @(#)CurvedPSDetector.java created 07/01/1999 Pergine Vals.
 *
...
public class CurvedPSDetector extends Detector {
  ...
  public CurvedPSDetector(XRDcat aobj) {
    this(aobj, "Curved Position Sensitive");
  }

  public CurvedPSDetector() {
    identifier = "Curved Position Sensitive";
    IDlabel = "Curved Position Sensitive";
    description = "Curved Position Sensitive detector";
  }
