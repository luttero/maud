/*
 * @(#)ScintillationDetector.java created 07/01/1999 Pergine Vals.
 *
...
public class ScintillationDetector extends StandardDetector {
  ...
  public ScintillationDetector(XRDcat aobj) {
    this(aobj, "Scintillation");
  }

  public ScintillationDetector() {
    identifier = "Scintillation";
    IDlabel = "Scintillation";
    description = "Scintillation detector";
  }
