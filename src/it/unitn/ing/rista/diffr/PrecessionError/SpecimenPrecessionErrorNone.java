/*
 * @(#)SpecimenPrecessionErrorNone.java created 08/10/2002 Mesiano
 *
...
public class SpecimenPrecessionErrorNone extends SpecimenPrecessionError {
  ...
  public SpecimenPrecessionErrorNone(XRDcat aobj) {
    this(aobj, "No specimen precession error applied");
  }

  public SpecimenPrecessionErrorNone() {
    identifier = "No precession";
    IDlabel = "No precession";
    description = "No specimen precession error applied";
  }
