...
public class AngleEnergyMapInstrumentBroadening extends InstrumentBroadening {
	...
	class JEDMapOptionsD extends JOptionsDialog {
		...
		public JEDMapOptionsD(Frame parent, XRDcat obj) {
			...
			PLPanel = new JParameterListPane[AngleEnergyMapInstrumentBroadening.this.parameterloopField.length];
			for (int i = 0; i < AngleEnergyMapInstrumentBroadening.this.parameterloopField.length; i++) {
		...
		public void initParameters() {
			for (int i = 0; i < AngleEnergyMapInstrumentBroadening.this.parameterloopField.length; i++) {
				PLPanel[i].setList(AngleEnergyMapInstrumentBroadening.this, i);
			}
		}
