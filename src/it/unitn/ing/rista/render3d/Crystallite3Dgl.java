/*
 * @(#)Crystallite3Dgl.java created 01/01/1997 Mesiano
 *
...
/**
 * The Crystallite3Dgl is a class
 *
...
public class Crystallite3Dgl extends AnimatedRendering3Dgl {
  ...
  public Crystallite3Dgl(Shape3D crystalliteShape, int drawmode,
                         int resolution, double scaleplot) {
    super(crystalliteShape, drawmode, resolution);
//, g, glCaps);
...
//    double xvect[] = null;
    ...
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_SPECULAR, FloatBuffer.wrap(Constants.crystallite_mat_specular));
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_SHININESS, FloatBuffer.wrap(Constants.crystallite_mat_shininess));
    gl.glMaterialfv(GL.GL_FRONT, GL2.GL_AMBIENT_AND_DIFFUSE, FloatBuffer.wrap(cryst_color));
...
/* cannot use triangle fan on texturing (s coord. at top/bottom tip varies) */
    ...
    gl.glColor4fv(FloatBuffer.wrap(cryst_color));
    if (mode == 1) {
