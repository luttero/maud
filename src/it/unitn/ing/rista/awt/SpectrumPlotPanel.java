...
*/
						...
						for (int ijn = 0; ijn < numberradiation; ijn++) {
							...
							for (int i = j = 0; i < numberofPeaks; i++, j += 2) {
								...
								double dspace = 0;
								if (ijn < dataset.getActiveDataFile(0).getReflections(tmpphase).size()) {
									double pos = dataset.getActiveDataFile(0).getPosition(tmpphase, reflIndex, ijn);
...
*/
					    ...
					    for (int ijn = 0; ijn < numberradiation; ijn++) {
						    ...
						    for (i = j = 0; i < numberofPeaks; i++, j += 2) {
							    ...
							    double dspace = 0;
							    if (ijn < datafile[0].getReflections(tmpphase).size()) {
								    double pos = datafile[0].getPosition(tmpphase, reflIndex, ijn);
...
*/
            ...
            for (int ijn = 0; ijn < numberradiation; ijn++) {
              ...
              for (i = j = 0; i < numberofPeaks; i++, j += 2) {
                ...
                double pos = adataset.getActiveDataFile(0).getPosition(tmpphase, reflIndex, ijn);
