/*
 * @(#)LProperties.java created 98/07/01 xxx
 *
...
/**
 * The <code>LProperties</code> class represents a persistent set of
 * properties. The <code>LProperties</code> can be saved to a stream
 * or loaded from a stream. Each key and its corresponding value in
 * the property list is a string.
 *
 * <p>A property list can contain another property list as its
 * "defaults"; this second property list is searched if
 * the property key is not found in the original property list.
 *
 * @author  Arthur van Hoff, Luca Lutterotti
 * @version $Revision: 1.4 $, $Date: 2004/08/12 09:36:10 $
 * @since   JDK1.0
 */
public class LProperties extends Hashtable {
  /**
   ...
   * @since   JDK1.0
   */
  protected LProperties defaults;
   ...
   * @since   JDK1.0
   */
  public LProperties(LProperties defaults) {
...
/*  public synchronized void save(OutputStream out, String header) {
   ...
   * @see     it.unitn.ing.rista.util.LProperties#defaults
   * @since   JDK1.0
   */
