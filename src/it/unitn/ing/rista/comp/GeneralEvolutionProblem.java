/*
 * @(#)GeneralEvolutionProblem.java created Mar 27, 2003 Berkeley
 *
...
/**
 * The GeneralEvolutionProblem is a class
 *  
...
//      System.out.println(initArgs[i * 2 + 1]);
    }
    defL *= 2;
    for (int i = 0; i < inputL; i++) {
      initArgs[defL + i] = args[i];
    }
/*    for (int i = 1; i < inputL; i+=2) {
      System.out.println(initArgs[defL + i]);
    }
    System.out.flush();  */
  ...
  public void evaluate(final EvolutionState state,
    ...
    if (!(ind instanceof DoubleVectorIndividual))
      state.output.fatal(
              "The individuals for this problem should be DoubleVectorIndividual.");
...
// generation, and the prefix to all the files would be "ec.*"
    ...
    "eval.problem=it.unitn.ing.rista.comp.GeneralEvolutionProblem",
