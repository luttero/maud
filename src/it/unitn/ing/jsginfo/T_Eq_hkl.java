/*
 * @(#)T_Eq_hkl.java	0.10 created 10/10/1999 Pergine Vals.
 *
...
/**
 * The T_Eq_hkl contains many small classes.
 *
 *
...
public class T_Eq_hkl {
  ...
  public int N;                /* Number of equivalent hkl to follow */
  public int[] h = new int[24];
  public int[] k = new int[24];
  public int[] l = new int[24];
  public int[] TH = new int[24]; /* Phase shift relative to h[0], k[0], l[0] */
