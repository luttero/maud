/*
 * @(#)T_HallGenerator.java	0.10 created 10/10/1999 Pergine Vals.
 *
...
/**
 * The T_HallGenerator contains many small classes.
 *
 *
...
public class T_HallGenerator {
  public int Improper, Rotation, RefAxis, DirCode, Screw;
  public T_RTMx SeitzMx = new T_RTMx();

  public T_HallGenerator() {
    super();
  }
}
