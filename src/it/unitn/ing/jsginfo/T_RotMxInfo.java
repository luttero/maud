/*
 * @(#)T_RotMxInfo.java	0.10 created 10/10/1999 Pergine Vals.
 *
...
/**
 * The T_RotMxInfo contains many small classes.
 *
 *
...
public class T_RotMxInfo {
  ...
  public void setRefAxis(char code) {
    RefAxis = code;
  }

  public void setRefAxis(int code) {
    RefAxis = (char) code; //Character.forDigit(code, Character.MAX_RADIX);
  }
  ...
  public int getIntRefAxis() {
    return RefAxis; //Character.getNumericValue(RefAxis);
  }
}
