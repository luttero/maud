...
//	Initialize the crypto algorithm and define the algorithm
    Crypto.initRandom();
    newkey = new BlowfishKey(Server.keyCode.getBytes());
  }

  public Encryption(String keycode) {
//	Initialize the crypto algorithm and define the algorithm
    Crypto.initRandom();
    newkey = new BlowfishKey(keycode.getBytes());
  }
...
//    System.out.println("Passwd("+type+")="+outTotal.toXRDcatString());
