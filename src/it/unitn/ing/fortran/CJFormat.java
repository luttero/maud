 ...
 *
 * This file was downloaded by JNP on 3/6/1998 from
 * http://www.apl.jhu.edu/~hall/java/CoreJava-Format.java
 * Modified by JNP 3/6/1998 to use in Fortran format simulator
 * for IFS.
 * 1) Changed name of class from Format to CJFormat to avoid
 *    name clashes.
 * 2) Added public methods to set the private variables such
 *    as width. This means we can use the class without having
 *    to construct a printf-style format string. Also added
...
public class CJFormat {
   ...
   * Use multiple CJFormat objects to format more than one number
  ...
  public void setLeadingZeroes(boolean leading_zeroes) {
    this.leading_zeroes = leading_zeroes;
  }


  public void setShowPlus(boolean show_plus) {
    this.show_plus = show_plus;
  }
  ...
  public void setShowSpace(boolean show_space) {
    this.show_space = show_space;
  }
