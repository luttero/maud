...
public class FormatParserTokenManager implements FormatParserConstants {
  ...
  public static final String[] jjstrLiteralImages = {
    "", null, null, null, "\101", "\111", "\106", "\56", "\105", "\130", "\57",
    "\50", "\51", "\54", };
  ...
  public FormatParserTokenManager(ASCII_CharStream stream) {
    if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
    input_stream = stream;
  }

  public FormatParserTokenManager(ASCII_CharStream stream, int lexState) {
    this(stream);
    SwitchTo(lexState);
  }
