...
public class NumberParserTokenManager implements NumberParserConstants {
  ...
  static final int[] jjnextStates = {
    9, 10, 15, 16, 19, 20, 6, 7, 13, 14, 17, 18, 21, 22,
  };
  public static final String[] jjstrLiteralImages = {
    "", null, null, null, null, "\40", "\55", "\53", };
  ...
  public NumberParserTokenManager(ASCII_CharStream stream) {
    if (input_stream != null)
      throw new TokenMgrError("ERROR: Second call to constructor of static lexer. You must use ReInit() to initialize the static variables.", TokenMgrError.STATIC_LEXER_ERROR);
    input_stream = stream;
  }

  public NumberParserTokenManager(ASCII_CharStream stream, int lexState) {
    this(stream);
    SwitchTo(lexState);
  }
