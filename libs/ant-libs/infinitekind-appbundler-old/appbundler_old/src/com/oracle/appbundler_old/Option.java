 ...
 * is {@code com.oracle.appbundler_old}. Then you can override a named option by calling
 * <xmp>
 *     import java.util.prefs.Preferences;
 *     [...]
 *     Preferences jvmOptions = Preferences.userRoot().node("/com/oracle/appbundler_old/JVMOptions");
 *     jvmOptions.put("name", "value");
 *     jvmOptions.flush();
 * </xmp>
 * The corresponding entries will be stored in a file called
 * {@code ~/Library/Preferences/com.oracle.appbundler_old.plist}.
 ...
 * <xmp>
 *     defaults write com.oracle.appbundler_old /com/oracle/appbundler_old/ -dict-add JVMOptions/ '{"name"="value";}'
 * </xmp>
 *
