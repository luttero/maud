...
namespace tensor_rank_2 {
    ...
    bool reciprocal_space)
  {
    ...
    unsigned long n_rows = (symmetry_matrices.size() - i_first_matrix_to_use) * 6;
  ...
  */
  ...
  protected:
               ...
               af::const_ref<sgtbx::rt_mx> const& symmetries)
    {
       ...
       */
      const unsigned long n_a_rows = symmetries.size() * n_all_params;
      const unsigned long max_n_a_rows = symmetries_max_nb * n_all_params;
